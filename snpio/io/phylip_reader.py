...
class PhylipReader(GenotypeData):
    ...
    Attributes:
        ...
        guidetree (str): Name of the guide tree file.
        qmatrix_iqtree (str): Name of the Q-matrix file generated by IQ-TREE.
        qmatrix (str): Name of the Q-matrix file.
        siterates (str): Name of the site rates file.
        siterates_iqtree (str): Name of the site rates file generated by IQ-TREE.
    ...
    def __init__(
        ...
        Args:
            ...
            guidetree (str, optional): Name of the guide tree file. Defaults to None.
            qmatrix_iqtree (str, optional): Name of the Q-matrix file generated by IQ-TREE. Defaults to None.
            qmatrix (str, optional): Name of the Q-matrix file. Defaults to None.
            siterates (str, optional): Name of the site rates file. Defaults to None.
            siterates_iqtree (str, optional): Name of the site rates file generated by IQ-TREE. Defaults to None.
        ...
        """
        kwargs = {"prefix": prefix, "verbose": self.verbose, "debug": debug}
