...
\begin{titlepage}
\centering
\includegraphics[width=0.75\textwidth]{snpio/img/snpio_logo.png}
\vfill
\vspace{0.5in}
{\Huge\bfseries SNPio: A Python API for Population Genetic File Processing, Filtering, and Encoding\par}
\vspace{0.25in}
{\Large\bfseries Getting Started with SNPio\par}
\vspace{0.25in}
{\Large Drs. Bradley T. Martin and Tyler K. Chafin\par}
\vspace{0.3in}
{\Large Version: 1.3.21\par}
\vspace{0.25in}
{\Large 06-16-2025}
\end{titlepage}
