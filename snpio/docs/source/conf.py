...
# -- Project information -----------------------------------------------------
project = "SNPio"
copyright = "2023-2026, SNPio developers"
author = "Bradley T. Martin et al."
release = "1.7.1"
...
html_context = {
    ...
    "conf_py_path": "/snpio/docs/source/",  # Path to docs in the repo
    "current_version": "v1.7.1",  # Project version
